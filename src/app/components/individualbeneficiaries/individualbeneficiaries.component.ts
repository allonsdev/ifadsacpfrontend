...
@Component({
  selector: 'individualbeneficiaries',
  templateUrl: './individualbeneficiaries.component.html',
})
export class IndividualbeneficiariesComponent implements OnInit {
  currentUser: any;
  dataTable: any;
  id: number = 0;
  ...
  public getRegister() {
    const apiEndpoint = apiUrl + '/api/Beneficiary/GetBeneficiaries';
