...
@Component({
  selector: 'app-school-business-units-duplicates',
  templateUrl: './school-business-units-duplicates.component.html',
})
export class SchoolBusinessUnitsDuplicatesComponent implements OnInit {
  currentUser: any;
  dataTable: any;
  selectedIds: number[] = [];
  ...
  public getDuplicates() {
    const apiEndpoint = apiUrl + '/api/Duplicates/school-business-units';
  ...
  public bulkDelete() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.http
          .delete(apiUrl + '/api/Duplicates/school-business-units/bulk', { body: this.selectedIds })
          .subscribe(
            () => {
              this.selectedIds = [];
              this.getDuplicates();
  ...
  private initializeDataTable(data: any[]) {
      ...
      createdCell: (cell: any, cellData: any, rowData: any) => {
        ...
        btn.addEventListener('click', () => {
          Swal.fire({
            ...
            if (result.isConfirmed) {
              this.http.delete(apiUrl + '/api/Duplicates/school-business-units/' + id).subscribe(
                () => {
                  this.getDuplicates();
    ...
    this.dataTable = $('#dtSchoolBusinessUnitsDuplicates').DataTable(dtOptions);
